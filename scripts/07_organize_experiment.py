...
_SNAPSHOT_KEYS: list[tuple[str, list[str]]] = [
    ...
    ("wiener.protected_band_hz", ["wiener", "protected_band_hz"]),
    ("wiener.coherent_gate_enabled", ["wiener", "coherent_gate_enabled"]),
    ("wiener.coherent_gate_threshold_uv", ["wiener", "coherent_gate_threshold_uv"]),
